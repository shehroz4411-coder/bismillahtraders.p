/* =========================================================
   SPANISH FAST FOOD
   COMPLETE CART + BRANCH + WHATSAPP SYSTEM
========================================================= */
...
function initCart() {
    ...
    function getSelectedBranch() {
        ...
        if (selectedOption) {
            ...
            if (text.includes("taxila")) {

                return BRANCHES.taxila;

            }


            if (
                text.includes("hassan") &&
                text.includes("abdal")
            ) {

                return BRANCHES["hassan-abdal"];
